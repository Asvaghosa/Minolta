...
{
	DATATYPE_GLOSS = 0,			//CM-25cG:GU, CM-26dG:GU
	DATATYPE_SPEC = 1,			//CM-25cG:spectrum data

	DATATYPE_SCI = 1,			//CM-26dG:SCI, CM-26d/CM-25d:SCI
	DATATYPE_SCE = 2,			//CM-26dG:SCE, CM-26d/CM-25d:SCE
	DATATYPE_BACKWHITE = 3,		//CM-26dG/CM-26d/CM-25d:Opacity back white
	DATATYPE_BACKBLACK = 4,		//CM-26dG/CM-26d/CM-25d:Opacity back black

	DATATYPE_SCI_UVFULL = 10,	//CM-26dG/CM-26d
	DATATYPE_SCE_UVFULL = 11,	//CM-26dG/CM-26d
	DATATYPE_SCI_UVCUT = 12,	//CM-26dG/CM-26d
	DATATYPE_SCE_UVCUT = 13,	//CM-26dG/CM-26d
	DATATYPE_SCI_UVADJ = 14,	//CM-26dG/CM-26d
	DATATYPE_SCE_UVADJ = 15,	//CM-26dG/CM-26d
...
{
	UV_100 = 0,		//UV full
	UV_CUT400,		//UV 400nm cut
	UV_CUT420,		//UV 420nm cut
	UV_CUT400N,		//UV adjust 400nm cut Normal flash
	UV_CUT400L,		//UV adjust 400nm cut Low flash
	UV_CUT420N,		//UV adjust 420nm cut Normal flash
	UV_CUT420L,		//UV adjust 420nm cut Low flash
	UV_100_CUT400,	//UV full + 400nm cut
	UV_100_CUT420,	//UV full + 420nm cut
	UV_100_CUT400N,	//UV full + adjust 400nm cut Normal flash
	UV_100_CUT400L,	//UV full + adjust 400nm cut Low flash
	UV_100_CUT420N,	//UV full + adjust 420nm cut Normal flash
	UV_100_CUT420L,	//UV full + adjust 420nm cut Low flash
